...
def test_standard_version(version):
    ...
    assert (
        f"https://www.cirm.org/rtz/RTZ%20Schema%20version%20{str(version).replace('.', '_')}.xsd" in schema_locations[0]
    )
