...
* Minimum Python version changed to 3.11
...
* Upgrading project dependencies
  [#287](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/287)
* Replacing Safety with UV audit for Python dependencies vulnerability scanning
  [#288](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/288)
...
* Package pre-releases support
  [#271](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/271)
* Page element within descriptive series elements
  [#272](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/272)
* Local code list values for map products and web map products
  [#273](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/273)
* Metadata constraints element
  [#276](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/276)
* MAGIC Administration metadata profile v1
  [#277](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/277)
...
* Refactored MAGIC Discovery metadata profile v1 schema and supporting alternate domain consistency URL
  [#269](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/269)
...
* Local code list values for physical map products
  [#260](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/260)
...
* Incorrect href for MAGIC Discovery profile schema
  [#258](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/258)
...
* Incorrect href for MAGIC Discovery profile schema
  [#254](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/254)
...
* Profile validation for ISO 19115
  [#247](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/247)
...
* Missing timezones from datetimes used in test record configurations
 [#221](https://gitlab.data.bas.ac.uk/uk-pdc/metadata-infrastructure/metadata-library/-/issues/221)
