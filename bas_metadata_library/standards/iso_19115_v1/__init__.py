...
class MetadataRecordConfig(_MetadataRecordConfig):
    ...
    def __init__(self, **kwargs: dict):
        ...
        self.schema = {
            ...
            "definitions": {
                ...
                "constraint": {
                    ...
                    "properties": {
                        ...
                        "inspire_limitations_on_public_access": {"type": "string", "enum": ["noLimitations"]},
                ...
                "contact": {
                    ...
                    "additionalProperties": False,
                    "properties": {
                        "individual": {"$ref": "#/definitions/contact_identity"},
                        "organisation": {"$ref": "#/definitions/contact_identity"},
                        "email": {"type": "string", "format": "email"},
                        "phone": {"type": "string"},
                        "address": {"$ref": "#/definitions/address"},
                        "online_resource": {"$ref": "#/definitions/online_resource"},
                        "role": {
                            "type": "array",
                            "items": {
                                "type": "string",
                ...
                "dates": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "date_precision": {"type": "string", "enum": ["month", "year"]},
                            "date_type": {
                                "type": "string",
                                "enum": [
                                    "creation",
                ...
                "geographic_extent": {
                    ...
                    "properties": {
                        "bounding_box": {
                            ...
                            "additionalProperties": False,
                            "properties": {
                                "west_longitude": {"type": "number", "maximum": 180, "minimum": -180},
                                "east_longitude": {"type": "number", "maximum": 180, "minimum": -180},
                                "south_latitude": {"type": "number", "maximum": 90, "minimum": -90},
                                "north_latitude": {"type": "number", "maximum": 90, "minimum": -90},
                            },
                        }
                    },
                },
                    ...
                    "properties": {
                        "terms": {
                            ...
                            "items": {
                                ...
                                "required": ["term"],
                                "additionalProperties": False,
                                "properties": {"term": {"type": "string"}, "href": {"type": "string", "format": "uri"}},
                            },
                        },
                        "type": {"type": "string", "enum": ["discipline", "place", "stratum", "temporal", "theme"]},
                        "thesaurus": {"$ref": "#/definitions/thesaurus"},
                    },
                },
                ...
                "online_resource": {
                    ...
                    "properties": {
                        ...
                        "function": {
                            "type": "string",
                            "enum": ["download", "information", "offlineAccess", "order", "search"],
                        },
                    },
                },
                "temporal_extent": {
            ...
            "type": "object",
            "required": ["contacts", "date_stamp", "resource"],
            "additionalProperties": False,
            "properties": {
                ...
                "contacts": {"type": "array", "items": {"$ref": "#/definitions/contact"}, "minItems": 1},
                ...
                "reference_system_info": {
                    ...
                    "properties": {
                        "code": {
                            ...
                            "required": ["value"],
                            "additionalProperties": False,
                            "properties": {"value": {"type": "string"}, "href": {"type": "string", "format": "uri"}},
                        },
                        "version": {"type": "string"},
                        "authority": {
                            "type": "object",
                ...
                "resource": {
                    "type": "object",
                    "required": ["title", "dates", "abstract", "language"],
                    "additionalProperties": False,
                    "properties": {
                        "title": {"$ref": "#/definitions/title"},
                        ...
                        "maintenance": {"$ref": "#/definitions/maintenance"},
                        "keywords": {"type": "array", "items": {"$ref": "#/definitions/keywords"}},
                        "constraints": {
                            "type": "object",
                            "required": [],
                            "additionalProperties": False,
                            "properties": {
                                "access": {"type": "array", "items": {"$ref": "#/definitions/constraint"}},
                                "usage": {"type": "array", "items": {"$ref": "#/definitions/constraint"}},
                            },
                        },
                        "supplemental_information": {"type": "string"},
                        "spatial_representation_type": {
                            "type": "string",
                            "enum": ["vector", "grid", "textTable", "tin", "steroModel", "video"],
                        },
                        ...
                        "extent": {
                            ...
                            "additionalProperties": False,
                            "properties": {
                                "geographic": {"$ref": "#/definitions/geographic_extent"},
                                "vertical": {"$ref": "#/definitions/vertical_extent"},
                                "temporal": {"$ref": "#/definitions/temporal_extent"},
                            },
                        },
                        "formats": {
                            "type": "array",
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "size": {
                                        ...
                                        "additionalProperties": False,
                                        "required": [],
                                        "properties": {"unit": {"type": "string"}, "magnitude": {"type": "number"}},
                                    },
                                    "online_resource": {"$ref": "#/definitions/online_resource"},
                                },
                            },
