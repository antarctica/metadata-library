...
class MetadataRecordConfig(_MetadataRecordConfig):
    ...
    def __init__(self, **kwargs: dict):
        ...
        self.schema = {
            ...
            "metadata standard",
            "definitions": {
                "contact": {"required": ["organisation", "email"]},
            ...
            "allOf": [
                ...
                {
                    "required": ["language", "hierarchy_level"],
                    "properties": {
                        "hierarchy_level": {"enum": ["dataset", "series", "service"]},
                        "contacts": {"items": {"$ref": "#/definitions/contact"}},
                        "reference_system_info": {
                            "properties": {"authority": {"properties": {"contact": {"$ref": "#/definitions/contact"}}}}
                        },
                        "resource": {
                            "required": ["extent", "constraints", "topics", "lineage"],
                            "properties": {
                                "dates": {"contains": {"properties": {"date_type": {"enum": ["creation"]}}}},
                                "identifiers": {"minItems": 1},
                                "contacts": {
                                    "items": {"$ref": "#/definitions/contact"},
                                    "contains": {"properties": {"role": {"contains": {"enum": ["pointOfContact"]}}}},
                                },
                                "keywords": {
                                ...
                                "topics": {"minItems": 1},
                                "constraints": {
                                    "required": ["access", "usage"],
                                    "properties": {
                                        "access": {"contains": {"required": ["inspire_limitations_on_public_access"]}},
                                        "usage": {
                                            "contains": {
                                                "anyOf": [
                                                    {"required": ["copyright_licence"]},
                                                    {"required": ["statement"]},
                                                ]
                                            }
                                        },
                                ...
                                "measures": {
                                    "contains": {
                                        "properties": {
                                            "code": {"enum": ["Conformity_001"]},
                                            "code_space": {"enum": ["INSPIRE"]},
                                        }
                                    }
                                },
                            },
